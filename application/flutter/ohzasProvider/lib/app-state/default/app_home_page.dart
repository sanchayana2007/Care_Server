...
import 'package:ohzasProvider/app-state/about_page.dart';
import 'package:ohzasProvider/app-state/contactus_page.dart';
import 'package:ohzasProvider/app-state/default/service_book_history_page.dart';
import 'package:ohzasProvider/app-state/default/service_book_page.dart';
...
import 'package:ohzasProvider/app-state/default/service_provider_home.dart';
...
//              ),
              InkWell(
                onTap: () async {
                  ...
                  // }
                  Toaster.e(context, message: 'This option is coming soon.');
                },
                child: ListTile(
                        ...
                        return Card(
                          ...
                          child: Container(
                            ...
                            child: InkWell(
                              ...
                              onTap: () {
                                Log.i(serviceList[position]['_id']);
                                Navigator.of(_context).pushReplacement(
                                  MaterialPageRoute(
                                    builder: (context) => ServiceProviderHome(),
                                    settings: RouteSettings(
                                    arguments: serviceList[position]['_id'],
                                  ),
                                  ),
                                );
