...
@xenSecureV1
class VehicleTypeHandler(cyclone.web.RequestHandler, MongoMixin):
            ...
            if len(profile):
                ...
                if len(app):
                    if app[0]['apiId'] == 20216: # TODO: till here
                        ...
                        if vTypeId != None:
                            vTypes = yield self.vehicleType.find(
                                        {
                                            '_id': vTypeId,
                                            'entityId': self.entityId,
                                            'disabled': tDisabled
            ...
            if len(profile):
                ...
                if len(app):
                    if app[0]['apiId'] == 20216: # TODO: till here
                        ...
                        # TODO: for vehicle model
                        '''
                        fMinValue = self.request.arguments.get('models')
                        code, message = Validate.i(
                                    fMinValue,
                                    'Min Value',
                                    dataType=int,
                        ...
                        try:
                            ...
                            status = True
                            code = 2000
                            message = 'New Vehicle Type has been created.'
                        except:
                            status = False
                            code = 4280
                            message = 'This Vehicle Type is already exists.'
                    else:
                        code = 4003
                        self.set_status(401)
                        message = 'You are not Authorized.'
            ...
            if len(profile):
                ...
                if len(app):
                    if app[0]['apiId'] == 20216: # TODO: till here
                        ...
                        try:
                            updateResult = yield self.vehicleType.find_and_modify(
                                    query = {
                                            '_id': vTypeId,
                                            'entityId': self.entityId
                                        },
                            ...
                            if updateResult:
                                status = True
                                code = 2000
                                message = 'Vehicle Type details has been updated.'
                            else:
                                code = 4210
                                message = 'This Vehicle Type does not exist.'
                        except:
                            status = False
                            code = 4280
                            message = 'This Vehicle Type is already exists.'
                ...
                if len(app):
                    if app[0]['apiId'] == 20216: # TODO: till here
                        ...
                        if updateResult:
                            status = True
                            code = 2000
                            message = 'Vehicle Type has been Disabled.'
                        else:
                            code = 4210
                            message = 'This Vehicle Type does not exist.'
                    else:
