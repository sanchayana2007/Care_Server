...
@xenSecureV1
class DriverHandler(cyclone.web.RequestHandler, MongoMixin):
                            ...
                            if len(aProfile):
                                ...
                                if len(pAccount):
                                    ...
                                    if len(pServiceAccount):
                                        ...
                                        v['drivingLicense'] = pServiceAccount[0].get('drivingLicense')
                                        v['aadhaar'] = pServiceAccount[0].get('aadhaar')
                                    result.append(v)
                                else:
                                    code = 3002
                                    message = 'No Driver Account Found.'
                            else:
                                code = 3001
                                message = 'No Driver Account Found.'
                        else:
                                    ...
                                    for p in aProfiles:
                                        ...
                                        if len(pAccount):
                                            ...
                                            if len(pServiceAccount):
                                                ...
                                                v['aadhaar'] = pServiceAccount[0].get('aadhaar')
                                            # Profile Picture
                                            v['profilePicture'] = self.fu.uploadsPath + str(self.entityId) + '/profile/' + v['id'] + '/profile.png'
                                            result.append(v)
                                    if len(result):
                                        status = True
                                        code = 2000
            ...
            if len(profile):
                ...
                if len(app):
                    if app[0]['apiId'] == 20216: # TODO: till here
                        ...
                        drivingLicense = self.request.arguments.get('drivingLicense')
                        code, message = Validate.i(
                                drivingLicense,
                                'Driving License',
                                dataType=unicode,
                        ...
                        aadhaar = self.request.arguments.get('aadhaar')
                        code, message = Validate.i(
                                aadhaar,
                                'Aadhaar Number',
                                dataType=unicode,
                        ...
                        if not len(profileApplication):
                            ...
                            try:
                                ...
                                code = 2000
                                message = 'New Driver Account has been created.'
                                status = True
                            except Exception as e:
                                code = 5833
                                message = 'Internal Error, Please Contact the Support Team.'
            ...
            if len(profile):
                ...
                if len(app):
                    if app[0]['apiId'] == 20216: # TODO: till here
                        ...
                        drivingLicense = self.request.arguments.get('drivingLicense', None)
                        code, message = Validate.i(
                                drivingLicense,
                                'Driving License',
                                dataType=unicode,
                        ...
                        aadhaar = self.request.arguments.get('aadhaar', None)
                        code, message = Validate.i(
                                aadhaar,
                                'Aadhaar Number',
                                dataType=unicode,
                        ...
                        if updateResult:
                            updateResult = yield self.serviceAccount.find_and_modify(
                                query = {
                                        'profileId': profileId,
                                        'entityId': self.entityId
                                    },
                            ...
                            status = True
                            code = 2000
                            message = 'Driver Account details has been updated.'
                        else:
                            code = 4211
                ...
                if len(app):
                    if app[0]['apiId'] == 20216: # TODO: till here
                        ...
                        if updateResult:
                            status = True
                            code = 2000
                            message = 'Driver Account has been Closed.'
                        else:
                            code = 4210
                            message = 'This Driver Account does not exist.'
                    else:
