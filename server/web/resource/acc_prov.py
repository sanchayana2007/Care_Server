...
@xenSecureV1
class AccProvHandler(cyclone.web.RequestHandler, MongoMixin):
                        ...
                        if profileId != None:
                            ...
                            if len(aProfile):
                                ...
                                if len(pAccount):
                                    ...
                                    code = 3002
                                    message = 'No Accomodation Provider Account Found.'
                            else:
                                code = 3001
                                message = 'No Accomodation Provider Account Found.'
                        else:
                    ...
                    if app[0]['apiId'] == 402022: # TODO: till here
                        ...
                        if not len(profileApplication):
                            ...
                            try:
                                ...
                                # Sending Username and Password to the registered mobile Number
                                conn = http.client.HTTPSConnection("api.msg91.com")
                                sms = 'Hello! Your UserId is {} and your password is {}'.format(phoneNumber,rPassword)
                                payloadJson = {
                                                "sender":"SOCKET",
                                                "route":4,
                                                "country":91,
                                ...
                                if stat['type'] == "success":
                                    code = 2000
                                    message = 'New Accomodation Provider Account has been created.'
                                    status = True
                                else:
                                    status = False
                                    code = 5050
                ...
                if len(app):
                    if app[0]['apiId'] == 402022: # TODO: till here
                        ...
                        if updateResult:
                            status = True
                            code = 2000
                            message = 'Accomodation Provider Account details has been updated.'
                        else:
                            code = 4210
                            message = 'This Accomodation Provider Account does not exist.'
                    else:
                        self.set_status(401)
                        code = 4003
                        message = 'You are not Authorized.'
                ...
                if len(app):
                    if app[0]['apiId'] == 402022: # TODO: till here
                        ...
                        if updateResult:
                            status = True
                            code = 2000
                            message = 'Accomodation Provider Account has been Closed.'
                        else:
                            code = 4210
                            message = 'This Accomodation Provider Account does not exist.'
                    else:
