...
@noXenSecureV1
class SignUpHandler(cyclone.web.RequestHandler, MongoMixin):
    ...
    def post(self):
        ...
        try:
            ...
            if applicationId == None:
                ...
                raise Exception
            elif type(applicationId) != unicode:
                code = 4102
            ...
            if len(app) and app[0]['selfRegister']:
                ...
                if method == 0:
                    ...
                    try:
                        ...
                        if email != None and type(email) != unicode:
                            code = 4531
                    ...
                    if gwResp:
                        ...
                        sms = 'Hello! Your Profile Username is {} and your password is {}'.format(phoneNumber,rPassword)
                        payloadJson = {
                                        "sender":"SOCKET",
                                        "route":4,
                                        "country":91,
