...
@xenSecureV1
class MmsWebMapsGoogleDirections(cyclone.web.RequestHandler, MongoMixin):
            ...
            if len(profile):
                ...
                if len(app):
                    if app[0]['apiId'] == 40216: # TODO: till here
                        try:
                            origins = str(self.get_arguments('origin')[0]).split(',')
                            ...
                            if code != 4100:
                                raise Exception
                            destinations = str(self.get_arguments('destination')[0]).split(',')
                            code, message = Validate.i(
                                destinations,
                                'Destinations',
                                dataType=list,
