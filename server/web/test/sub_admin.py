...
@xenSecureV1
class MtimeSubAdminSignUpHandler(cyclone.web.RequestHandler,
                ...
                if len(app):
                    ...
                    if app[0]['apiId'] in [ 402022, 402023]: # TODO: till here
                        if self.apiId == 402022:
                            orgProf = yield self.profile.find(
                                        {
                                            'parentId':self.profileId
                                        },
                                        {
                                            '_id':0,
                                            'accountId':1
                            ...
                            if len(acc):
                                ...
                                status = True
                                message = "No Data Found"
                        elif self.apiId == 402023:
                            #TODO://Check get for subadmin
                            code = 2000
                            message = "None"
                            status = True
                        else:
    ...
    def post(self):
	    ...
	    profile = yield self.profile.find(
			...
			if self.apiId == 402022: # TODO: till here
                            ...
                            if len(app) and app[0]['selfRegister'] == False:
                                ...
                                if method == 0:
                                    ...
                                    try:
                                        ...
                                        childAcc = yield self.profile.update(
                                                {
                                                    '_id':self.profileId,
                                                },
                                                {
            ...
            if len(profile):
                ...
                if len(app):
                    ...
                    if self.apiId in [ 402020, 402021, 402022 ]: # TODO: till here
                        ...
                        '''
                        if rActivityId == 1 and self.apiId in [402020, 402021]:
